...
public  class  NewJFrame extends javax.swing.JFrame {
    ...
    for (int row = 0; row < tModel.getRowCount(); row++) {
        ...
        // Разбиение интервала на 3 потока
        double interval = (b - a) / 3;
        
        IntegralCalculatorThread thread1 = new IntegralCalculatorThread(a, a + interval, step);
        IntegralCalculatorThread thread2 = new IntegralCalculatorThread(a + interval, a + 2 * interval, step);
        IntegralCalculatorThread thread3 = new IntegralCalculatorThread(a + 2 * interval, b, step);
        ...
        try {
            ...
            double totalIntegral = thread1.getPartialSum() + thread2.getPartialSum() + thread3.getPartialSum();
    ...
    private final double b;          // Конец интервала
    ...
    public void run() {
        ...
        for (double x = a; x < b; x += step) {
            sum += Math.cos(x + step / 2) * step; // Метод средних прямоугольников
        }
        this.partialSum = sum;
    }
